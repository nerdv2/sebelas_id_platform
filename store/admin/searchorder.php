...
?>
	<tr>
		...
		<td p align="center" bgcolor="#FFFFFF"><a href="edit_order.php?id=<?php echo $data['id'];?>" title="Edit this product?"><img style="max-width:40px;max-height:40px;width:auto;height:auto;" src="img/Page-Edit.png"></img></a></td>
	</tr>
<?php
	}
?>
